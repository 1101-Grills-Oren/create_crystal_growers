...
public static final BlockEntityEntry<CrystalMinerBlockEntity> CRYSTAL_MINER = REGISTRATE
		.blockEntity("crystal_miner", CrystalMinerBlockEntity::new)
		.visual(() -> OrientedRotatingVisual.of(AllPartialModels.DRILL_HEAD), false)
		.validBlocks(AllBlocks.CRYSTAL_MINER)
		.renderer(() -> CrystalMinerRenderer::new)
		.register();
...
import dev.ember.create_crystal_growers.crystal_miner.CrystalMinerBlockEntity;
import dev.ember.create_crystal_growers.crystal_miner.CrystalMinerRenderer;
...
public class AllCgBlockEntityTypes {
