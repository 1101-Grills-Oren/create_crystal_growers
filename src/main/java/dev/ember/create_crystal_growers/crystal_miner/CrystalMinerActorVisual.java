...
public class CrystalMinerActorVisual extends ActorVisual {
	...
	public CrystalMinerActorVisual(VisualizationContext visualizationContext, VirtualRenderWorld contraption, MovementContext context) {
		super(visualizationContext, contraption, context);

		BlockState state = context.state;

		facing = state.getValue(CrystalMinerBlock.FACING);
